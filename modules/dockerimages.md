...
"homepage" : "https://docs.docker.com/userguide/dockerimages/",
"canonicalSource" : "https://docs.docker.com/userguide/dockerimages/",
"license" : "Apache 2.0"
}
-->
...
[previous](https://docs.docker.com/userguide/dockerizing/) [sections](https://docs.docker.com/userguide/usingdocker/)
...
We can see the images we've previously used in our [user guide](https://docs.docker.com/userguide/).
...
![indexsearch](https://docs.docker.com/userguide/search.png)
...
[Automated Builds](https://docs.docker.com/userguide/dockerrepos/#automated-builds) that allow you to
...
> **Note:**
> There are [a lot more instructions available to us in a Dockerfile](https://docs.docker.com/reference/builder).
...
> [`Dockerfile`](https://docs.docker.com/reference/builder/) reference for a
...
To learn more, check out the [Dockerfile tutorial](https://docs.docker.com/userguide/level1).
...
You can also remove images on your Docker host in a way [similar to containers](https://docs.docker.com/userguide/usingdocker) using the `docker rmi` command.
...
[Dockerfile tutorial](https://docs.docker.com/userguide/level1).
