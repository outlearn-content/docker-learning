...
"description" : "How to install Docker on Windows",
"freshnessDate" : 2015-10-20,
"homepage" : "https://docs.docker.com/installation/windows/",
"canonicalSource" : "https://docs.docker.com/installation/windows/",
"license" : "Apache 2.0"
}
-->
...
1. Right click the Windows Start Menu and choose **System**.
    ...
    ![Which version](https://docs.docker.com/installation/images/win_ver.png)
...
and virtualization support is enabled in BIOS and recognized by Windows.
    ...
    Under **CPU** you should see the following:
      ...
      ![Release page](https://docs.docker.com/installation/images/virtualization.png)
...
![Windows Architecture Diagram](https://docs.docker.com/installation/images/win_docker_host.svg)
...
3. Install Docker Toolbox by double-clicking the installer.
    ...
    ![Install Docker Toolbox](https://docs.docker.com/installation/images/win-welcome.png)
...
5. Press "Next" until you reach the "Ready to Install" page.
     ...
     ![Install](https://docs.docker.com/installation/images/win-page-6.png)
...
6. Press "Install"  to continue with the installation.
     ...
     ![All finished](https://docs.docker.com/installation/images/windows-finish.png)
