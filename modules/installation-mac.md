...
![Linux Architecture Diagram](https://docs.docker.com/installation/images/linux_docker_host.svg)
...
![OSX Architecture Diagram](https://docs.docker.com/installation/images/mac_docker_host.svg)
...
and choosing "Open" from the pop-up menu.
    ...
    ![Install Docker Toolbox](https://docs.docker.com/installation/images/mac-welcome-page.png)
...
4. Press "Continue" to install the toolbox.
    ...
    ![Standard install](https://docs.docker.com/installation/images/mac-page-two.png)
...
5. Press "Install" to perform the standard installation.
     ...
     ![Password prompt](https://docs.docker.com/installation/images/mac-password-prompt.png)
...
6. Provide your password to continue with the installation.
     ...
     ![All finished](https://docs.docker.com/installation/images/mac-page-finished.png)
...
2. Find the Docker Quickstart Terminal and double-click to launch it.
    ...
    * points the terminal environment to this VM
    ...
    Once the launch completes, the Docker Quickstart Terminal reports:
     ...
     ![All finished](https://docs.docker.com/installation/images/mac-success.png)
...
4. Enter the `http://localhost:49157` address (`localhost` is `0.0.0.0`) in your browser:
    ...
    ![Bad Address](https://docs.docker.com/installation/images/bad_host.png)
...
6. Enter the `http://192.168.59.103:49157` address in your browser:
    ...
    ![Correct Addressing](https://docs.docker.com/installation/images/good_host.png)
...
You can continue with the [Docker User Guide](https://docs.docker.com/userguide). If you are
